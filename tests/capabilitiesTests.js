...
describe('Capabilities', function() {
    ...
    it('should successfully render list all jobs and capability associated', async function() {
    ...
    it('should successfully search jobs list for job based on name and return capability details', async function() {
        await driver.get('http://localhost:3001/capabilities/findByJobName');
        const title = await driver.getTitle();
        expect(title).equal('Search for Capability by Job Name');
    ...
    it('should successfully render no job details if job searched does not exist', async function() {
        await driver.get('http://localhost:3001/capabilities/findByJobName');
        const title = await driver.getTitle();
        expect(title).equal('Search for Capability by Job Name');
